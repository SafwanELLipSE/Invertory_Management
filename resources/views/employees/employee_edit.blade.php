                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                              <div class="devit-card-custom">
                                                  ...
                                                  <div class="form-group">
                                                    <input name="experience" type="text" value="{{ $employee->experience }}" class="form-control" placeholder="Experience">
                                                  </div>
                                                  <div class="form-group">
                                                    <input type="number" name="salary" value="{{ $employee->salary }}" class="form-control" placeholder="Salary">
                                                  </div>
                                                  <div class="form-group">
                                                    <input type="text" name="vacation" value="{{ $employee->vacation }}" class="form-control" placeholder="Vacation">
                                                  </div>
                                              </div>
                                            </div>
                                        </div>
