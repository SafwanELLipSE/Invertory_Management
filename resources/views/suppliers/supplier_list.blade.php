                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li>
                                  <span class="bread-blod">All Suppliers List</span>
                                </li>
                            </ul>
                        </div>
                    </div>
              ...
              <div class="sparkline13-list">
                  <div class="sparkline13-hd">
                      <div class="main-sparkline13-hd">
                          <h1>All <span class="table-project-n">Suppliers</span> List</h1>
                      </div>
                  </div>
                          ...
                          <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                              ...
                              <thead>
                                  <tr>
                                      ...
                                      <th class="text-center" data-field="email" data-editable="true">Email</th>
                                      <th class="text-center" data-field="phone" data-editable="true">Phone</th>
                                      <th class="text-center" data-field="gender" data-editable="true">Gender</th>
                                      <th class="text-center" data-field="Supplier Type" data-editable="true">Supplier Type</th>
                                      <th class="text-center" data-field="payment method" data-editable="true">Payment Method</th>
                              ...
                              <tbody>
                                @foreach($suppliers as $item)
                                  <tr>
                                    ...
                                    <td>{!! App\Supplier::getGender($item->gender) !!}</td>
                                    <td>{!! App\Supplier::getSupplierType($item->type) !!}</td>
                                    <td>{!! App\Supplier::getPaymentMethod($item->payment_method) !!}</td>
                                    ...
                                    <td>
                                      <form  action="{{ route('supplier.delete') }}" method="post">
                                        ...
                                        <a href="{{ route('supplier.details',$item->id) }}" class="btn btn-primary btn-xs" style="color:#FFFFFF !important; margin-right: .2rem"><i class="fa fa-info-circle edu-informatio"></i> view</a><button type="submit" class="btn btn-danger btn-xs"><i class="fa fa-trash edu-informatio"></i> Delete</button>
                                      </form>
                                      </td>
                                  </tr>
                                @endforeach
