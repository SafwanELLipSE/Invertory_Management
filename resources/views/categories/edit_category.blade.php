                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li>
                                    <a href="{{route('category.all_categories')}}">All Categories List</a> <span class="bread-slash">/</span>
                                </li>
                                <li>
                                  <span class="bread-blod">Edit Category</span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<div class="row">
    ...
    <form action="{{ route('category.save_edit') }}" method="POST">
      @csrf
               ...
               <div class="row">
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="form-group">
                         ...
                         <input name="category" type="text" value="{{ $category->cat_name }}" class="form-control" placeholder="Edit Category">
                     </div>
                     <div class="row">
                         <div class="col-lg-12">
