                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Edit Salary Bill</span>
                                </li>
                            </ul>
                        </div>
                    </div>
      ...
      <div class="sparkline10-list mg-tb-30 responsive-mg-t-0 table-mg-t-pro-n dk-res-t-pro-0 nk-ds-n-pro-t-0">
        <div class="sparkline10-hd">
           <div class="main-sparkline10-hd">
               <h1>Edit Employee Salary Bill</h1>
           </div>
       </div>
    <form action="{{ route('salary.save_edit') }}" method="POST" enctype="multipart/form-data">
      @csrf
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="chosen-select-single mg-b-20">
                        ...
                        <select name="employee" data-placeholder="Choose a Category" class="chosen-select" tabindex="-1">
                            <option value="{{ $salary->employee_id }}">{{ $salary->employee->user->name }}</option>
                     ...
                     <div class="form-group">
                         <label>Year</label>
                         <input name="year" type="number" class="form-control" value="{{ $salary->year }}" placeholder="{{ $salary->year }}">
                     </div>
                     <div class="form-group">
                          <label>Do you Want to give Advance Salary?</label>
                         <select name="advance_salary_option" class="form-control">
                           <option value="{{ $salary->advanced_salary }}">{!! App\Salary::getAdvanced($salary->advanced_salary) !!}</option>
                     ...
                     <div class="form-group">
                         ...
                         <input name="advanced_amount" type="number" class="form-control" value="{{ $salary->advanced_amount }}" placeholder="{{ $salary->advanced_amount }}">
                     </div>
                     <div class="form-group">
                         <label>Personal Expanse</label>
                         <input name="personal_expanse" type="number" class="form-control" value="{{ $salary->personal_expanse }}" placeholder="{{ $salary->personal_expanse }}">
                     </div>
                     <div class="row">
                         <div class="col-lg-12">
