                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">All Salary Bill List</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                              ...
                              <tbody>
                                @foreach($salaries as $item)
                                  <tr>
                                    ...
                                    <td>{{ $item->month }}</td>
                                    <td>{{ $item->year }}</td>
                                    <td>{!! App\Salary::getStatus($item->status) !!}</td>
                                    ...
                                    <td>
                                      <form  action="{{ route('salary.delete') }}" method="post">
                                        ...
                                        <a href="{{ route('salary.details',$item->id) }}" class="btn btn-primary btn-xs" style="color:#FFFFFF !important; margin-right: .2rem"><i class="fa fa-info-circle edu-informatio"></i></a>
                                        <button type="submit" class="btn btn-danger btn-xs"><i class="fa fa-trash edu-informatio"></i></button>
                                        @if($item->status == 0)
                                          <a href="{{ route('salary.edit',$item->id) }}" class="btn btn-success btn-xs" style="color:#FFFFFF !important; margin-right: .2rem"><i class="fa fa-pencil edu-informatio"></i></a>
                                        @endif
                                      </form>
                                      @if($item->status == 1)
