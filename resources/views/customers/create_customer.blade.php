                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li>
                                  <span class="bread-blod">Add New Customer</span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<div class="row">
    ...
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
        <div class="admin-pro-accordion-wrap shadow-inner responsive-mg-b-30">
            ...
            <form action="{{ route('customer.save_created') }}" method="POST" enctype="multipart/form-data">
                @csrf
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              <div class="form-group">
                                  <input name="name" type="text" class="form-control" placeholder="Name of Customer">
                              </div>
                              <div class="form-group">
