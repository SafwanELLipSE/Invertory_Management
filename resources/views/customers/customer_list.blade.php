              ...
              <div class="sparkline13-list">
                  <div class="sparkline13-hd">
                      <div class="main-sparkline13-hd">
                          <h1>All <span class="table-project-n">Employees</span> List</h1>
                      </div>
                  </div>
                              ...
                              <tbody>
                                @foreach($customers as $item)
                                  <tr>
                                    ...
                                    <td>{!! App\Customer::getGender($item->gender) !!}</td>
                                    <td>{!! App\Customer::getPaymentMethod($item->payment_method) !!}</td>
                                    ...
                                    <td>
                                      <form  action="{{ route('customer.delete') }}" method="post">
                                        ...
                                        <a href="{{ route('customer.details',$item->id) }}" class="btn btn-primary btn-xs" style="color:#FFFFFF !important; margin-right: .2rem"><i class="fa fa-info-circle edu-informatio"></i> view</a><button type="submit" class="btn btn-danger btn-xs"><i class="fa fa-trash edu-informatio"></i> Delete</button>
                                      </form>
                                      </td>
                                  </tr>
                                @endforeach
